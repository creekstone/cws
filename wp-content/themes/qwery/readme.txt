...
WordPress version: required at least 5.0, tested up to 6.5.4
...
Please install and activate it before starting to use the theme Qwery.
...
Theme documentation is available on https://doc.themerex.net/qwery/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Qwery is Fontello.
