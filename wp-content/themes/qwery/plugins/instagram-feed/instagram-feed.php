...
if ( ! function_exists( 'qwery_instagram_feed_frontend_scripts_responsive' ) ) {
	...
	function qwery_instagram_feed_frontend_scripts_responsive( $force = false ) {
		qwery_enqueue_optimized_responsive( 'instagram_feed', $force, array(
			'css' => array(
				'qwery-instagram-feed-responsive' => array( 'src' => 'plugins/instagram-feed/instagram-feed-responsive.css', 'media' => 'all' ),
			)
		) );
	}
}
