...
if ( ! function_exists( 'qwery_woocommerce_get_css' ) ) {
	add_filter( 'qwery_filter_get_css', 'qwery_woocommerce_get_css', 10, 2 );
	function qwery_woocommerce_get_css( $css, $args ) {
...
$fdir = qwery_get_file_dir( 'plugins/woocommerce/woocommerce-skin.php' );
if ( ! empty( $fdir ) ) {
	require_once $fdir;
}
