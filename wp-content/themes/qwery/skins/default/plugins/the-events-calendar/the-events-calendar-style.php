...
if ( ! function_exists( 'qwery_tribe_events_get_css' ) ) {
	add_filter( 'qwery_filter_get_css', 'qwery_tribe_events_get_css', 10, 2 );
	function qwery_tribe_events_get_css( $css, $args ) {
