...
?>>
	...
	trx_addons_get_template_part('templates/tpl.featured.php',
								...
								apply_filters( 'trx_addons_filter_args_featured', array(
										...
										'thumb_bg' => true,
										'hover' => 'info_anim',
										'thumb_size' => qwery_get_thumb_size('full'),
...
if ( !function_exists( 'qwery_sc_icons_merge_scripts' ) ) {
	add_action("trx_addons_filter_merge_scripts", 'qwery_sc_icons_merge_scripts');
	function qwery_sc_icons_merge_scripts($list) {
