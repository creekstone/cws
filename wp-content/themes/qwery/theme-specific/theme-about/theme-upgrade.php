...
if ( ! function_exists( 'qwery_pro_add_section_to_about' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'trx_addons_action_theme_panel_section_end', 'qwery_pro_add_section_to_about', 10, 2 );
	 *
...
if ( ! function_exists( 'qwery_pro_add_button' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_action( 'trx_addons_action_theme_panel_activation_form', 'qwery_pro_add_button', 10, 2 );
	 *
	 * @param string $tab_id     A current tab ID of 'Theme panel'
	 * @param array $theme_info  A current theme info.
	 */
...
if ( ! function_exists( 'qwery_pro_add_form' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_action( 'trx_addons_action_theme_panel_activation_form', 'qwery_pro_add_form', 12, 2 );
	 *
	 * @param string $tab_id     A current tab ID of 'Theme panel'
	 * @param array $theme_info  A current theme info.
	 */
...
if ( ! function_exists( 'qwery_pro_add_messages' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_filter( 'qwery_filter_localize_script_admin', 'qwery_pro_add_messages' );
	 *
...
if ( ! function_exists( 'qwery_pro_get_custom_field' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_filter( 'qwery_filter_get_custom_field', 'qwery_pro_get_custom_field', 10, 5 );
	 *
...
if ( ! function_exists( 'qwery_pro_theme_setup3' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_action( 'after_setup_theme', 'qwery_pro_theme_setup3', 3 ); // 3 - add/remove Theme Options elements
	 */
...
if ( ! function_exists( 'qwery_pro_customizer_custom_controls' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_action( 'customize_register', 'qwery_pro_customizer_custom_controls' );
	 *
...
if ( ! function_exists( 'qwery_pro_get_pro_version_callback' ) ) {
	 ...
	 * if a current theme is free (with limited functionality).
	 *
	 * Hooks: add_action( 'wp_ajax_qwery_get_pro_version', 'qwery_pro_get_pro_version_callback' );
	 */
