...
if ( ! function_exists( 'qwery_customizer_action_switch_theme' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'after_switch_theme', 'qwery_customizer_action_switch_theme' );
	 */
...
if ( ! function_exists( 'qwery_customizer_setup3' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'after_setup_theme', 'qwery_customizer_setup3', 3 ); // 3 - add/remove Theme Options elements
	 */
...
if ( ! function_exists( 'qwery_customizer_setup4' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'after_setup_theme', 'qwery_customizer_setup4', 4 );
	 */
...
if ( ! function_exists( 'qwery_customizer_setup3_2' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'after_setup_theme', 'qwery_customizer_setup3_2', 3 ); // 3 - add/remove Theme Options elements
	 */
...
define( 'QWERY_CUSTOMIZE_PRIORITY', 200 );
...
if ( ! function_exists( 'qwery_customizer_custom_controls' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'customize_register', 'qwery_customizer_custom_controls' );
	 *
...
if ( ! function_exists( 'qwery_customizer_register_controls' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'customize_register', 'qwery_customizer_register_controls', 20 );
	 *
...
if ( ! function_exists( 'qwery_customizer_action_save_after' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'customize_save_after', 'qwery_customizer_action_save_after' );
	 *
...
if ( ! function_exists( 'qwery_customizer_save_css' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'qwery_action_save_options', 'qwery_customizer_save_css', 20 );
	 *
	 *        add_action( 'trx_addons_action_save_options', 'qwery_customizer_save_css', 20 );
	 *
	 */
...
if ( ! function_exists( 'qwery_merge_styles_convert_keys' ) ) {
	 ...
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_styles', 'qwery_merge_styles_convert_keys', 9999, 1 );
	 *        add_filter( 'qwery_filter_merge_styles_responsive', 'qwery_merge_styles_convert_keys', 9999, 1 );
	 *        add_filter( 'qwery_filter_merge_styles_single', 'qwery_merge_styles_convert_keys', 9999, 1 );
	 *        add_filter( 'qwery_filter_merge_styles_responsive_single', 'qwery_merge_styles_convert_keys', 9999, 1 );
	 *        add_filter( 'qwery_filter_merge_scripts', 'qwery_merge_styles_convert_keys', 9999, 1 );
...
if ( ! function_exists( 'qwery_customizer_add_blog_styles_and_scripts' ) ) {
	 ...
	 *
	 * Trigger filters "qwery_filter_enqueue_blog_styles" and "qwery_filter_enqueue_blog_scripts" to allow
...
if ( ! function_exists( 'qwery_customizer_merge_blog_styles' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_blog_styles_and_scripts()
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_styles', 'qwery_customizer_merge_blog_styles', 8, 1 );
	 *
...
if ( ! function_exists( 'qwery_customizer_merge_blog_styles_responsive' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_blog_styles_and_scripts()
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_styles_responsive', 'qwery_customizer_merge_blog_styles_responsive', 8, 1 );
	 *
...
if ( ! function_exists( 'qwery_customizer_merge_blog_scripts' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_blog_styles_and_scripts()
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_scripts', 'qwery_customizer_merge_blog_scripts' );
	 *
...
if ( ! function_exists( 'qwery_customizer_blog_styles' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'wp_enqueue_scripts', 'qwery_customizer_blog_styles', 1100 );
	 */
...
if ( ! function_exists( 'qwery_customizer_blog_styles_responsive' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'wp_enqueue_scripts', 'qwery_customizer_blog_styles_responsive', 2000 );
	 */
...
if ( ! function_exists( 'qwery_customizer_merge_single_styles' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_single_styles_and_scripts()
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_styles', 'qwery_customizer_merge_single_styles', 8, 1 );
	 *        add_filter( 'qwery_filter_merge_styles_single', 'qwery_customizer_merge_single_styles', 8, 1 );
	 *
...
if ( ! function_exists( 'qwery_customizer_merge_single_styles_responsive' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_single_styles_and_scripts()
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_styles_responsive', 'qwery_customizer_merge_single_styles_responsive', 8, 1 );
	 *        add_filter( 'qwery_filter_merge_styles_responsive_single', 'qwery_customizer_merge_single_styles_responsive', 8, 1 );
	 *
...
if ( ! function_exists( 'qwery_customizer_merge_single_scripts' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_single_styles_and_scripts()
	 *
	 * Hooks: add_filter( 'qwery_filter_merge_scripts', 'qwery_customizer_merge_single_scripts' );
	 *
...
if ( ! function_exists( 'qwery_customizer_single_styles' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_single_styles_and_scripts()
	 *
	 * Hooks: add_action( 'wp_enqueue_scripts', 'qwery_customizer_single_styles', 1020 );
	 */
...
if ( ! function_exists( 'qwery_customizer_single_styles_responsive' ) ) {
	 ...
	 * This function is a wrapper for qwery_customizer_add_single_styles_and_scripts()
	 *
	 * Hooks: add_action( 'wp_enqueue_scripts', 'qwery_customizer_single_styles_responsive', 2020 );
	 */
...
if ( ! function_exists( 'qwery_customizer_control_js' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'customize_controls_enqueue_scripts', 'qwery_customizer_control_js' );
	 *
	 * Trigger a filter 'qwery_filter_customizer_vars' to allow other modules to add their variables to the localization array.
	 */
		...
		wp_localize_script(
			'qwery-customizer', 'qwery_customizer_vars', apply_filters(
				'qwery_filter_customizer_vars', array(
					...
					'page_width_default' => apply_filters( 'qwery_filter_content_width', (int)qwery_get_theme_option( 'page_width' ) ),
...
if ( ! function_exists( 'qwery_customizer_preview_js' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'customize_preview_init', 'qwery_customizer_preview_js' );
	 */
...
if ( ! function_exists( 'qwery_customizer_css_template' ) ) {
	 ...
	 *
	 * Hooks: add_action( 'customize_controls_print_footer_scripts', 'qwery_customizer_css_template' );
	 */
		...
		if ( isset( $vars['page_width'] ) ) {
			if ( substr( $vars['page_width'], 0, 2 ) != '{{' ) {
				if ( empty( $vars['page_width'] ) || (int)$vars['page_width'] == 0 ) {
					$vars['page_width'] = apply_filters( 'qwery_filter_content_width', (int)qwery_get_theme_option( 'page_width' ) );
				}
				...
				$rez['sidebar_width']       = qwery_prepare_css_value( $vars['sidebar_width'] );
				$rez['sidebar_gap']         = qwery_prepare_css_value( $vars['sidebar_gap'] );
			} else {
...
if ( ! function_exists( 'qwery_customizer_fix_sidebars' ) && is_customize_preview() && is_front_page() ) {
	 ...
	 *
	 * Hooks: add_action( 'wp_footer', 'qwery_customizer_fix_sidebars' );
	 */
