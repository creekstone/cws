...
if ( ! function_exists( 'qwery_get_scheme_color_name' ) ) {
	function qwery_get_scheme_color_name( $color_name ) {
		return apply_filters( 'qwery_filter_get_scheme_color_name', $color_name );
	}
}
...
if ( ! function_exists( 'qwery_get_scheme_color' ) ) {
	function qwery_get_scheme_color( $color_name, $scheme = '' ) {
		...
		$color_name = qwery_get_scheme_color_name( $color_name );
